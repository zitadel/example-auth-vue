    ...
    <main class="flex-1 px-6 py-12">
      ...
      <div v-else class="max-w-5xl mx-auto">
        ...
        >
          <div class="flex items-center">
            ...
            <div class="ml-4">
              ...
              <p class="text-green-700 mt-1">You have successfully logged into the application.</p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white rounded-lg border border-gray-200 p-8">
          ...
          <p class="text-gray-600 mb-6">Below is the authentication data stored in your session:</p>
